...
namespace FilmsAndActors_App
{
    internal static class Program
    {
        ...
        static void RunTests()
        {
            ...
            Debug.Assert(testFilm.GetGenre() == "Test Genre", "Error: GetGenre failed.");
            Debug.Assert(testFilm.GetReleaseYear() == 2000, "Error: GetReleaseYear failed.");
            ...
            // Test Actor Class
            Debug.Assert(testActor.GetName() == "Test Actor", "Error: GetName failed.");
            Debug.Assert(testActor.GetAge() == 30, "Error: GetAge failed.");
            testActor.AddFilm("Test Film");
            Debug.Assert(testActor.GetFilms().Contains("Test Film"), "Error: AddFilm or GetFilms failed.");
